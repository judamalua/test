...
public class TripServiceTest extends AbstractTest {
	...
	public void testCreate() {
		...
		Assert.isTrue(trip.getTags().size() == 0);
	...
	public void testFindTripBySearchParameters() {
		...
		s.setDateRangeStart(new Date(2000, 02, 01));
		s.setDateRangeEnd(new Date(2050, 02, 01));
		final Collection<Trip> t = this.tripService.findTripsBySearchParameters(s);
		Assert.notNull(t);
		super.unauthenticate();
