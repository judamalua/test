...
public class TripService {
	...
	//Requirement 34
	public Collection<Trip> findTripsBySearchParameters(final Search search) {
		...
		final Collection<Trip> t1 = this.tripRepository.findTripsByTitleAndPricePublication(q, pricelow, pricehigh);
