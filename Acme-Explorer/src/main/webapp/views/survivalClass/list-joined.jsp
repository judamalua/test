...
<display:table name = "survivalClasses" id = "row" 
	requestURI = "survivalClass/explorer/list-joined.do" pagesize = "${pagesize}" class = "displaytag">
	...
	<display:column property = "location.name" title = "${locationName}" sortable = "true"/>
	
	<spring:message code = "survivalclass.location.gpsCoordinates" var = "gpsCoordinates"/>
	<display:column property = "location.gpsCoordinates" title = "${gpsCoordinates}" sortable = "true"/>
