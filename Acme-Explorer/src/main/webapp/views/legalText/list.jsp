...
<display:table name="legalTexts" id="legalText" requestURI="legalText/admin/list.do" pagesize="${pagesize}" class="displayTag">
	...
	<spring:message code="legalText.registrationDate" var="registrationDate"/>
	<display:column property="registrationDate" title="${registrationDate}" sortable="true"/>
